...
REM Restaure les sauvegardes Neo-backup de packages précisés dans le fichier "packages_cibles.txt" (et réinstalle le package s'il n'est pas installé)
...
set "LIST_FILE=%CD%\packages_cibles.txt"
