...
# Pallet APK Handler - Automated APK/APKS Installer

# Install ALL apk and apks files in the ./apks directory
# which are missing from the connected android device
