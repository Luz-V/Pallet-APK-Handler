REM Pallet APK Handler - Restauration de sauvegarde de type AppManager
...
REM Restaure les sauvegardes au format AppManager (et réinstalle le package s'il n'est pas installé)
REM les sauvegardes faites via AppManager sont détectés automatiquement dans l'arborescence
REM Ces sauvegardes incluent :
REM - L'installateur "base.apk" (+ éventuels APK splits), 
REM - Un fichier de métadonnés "meta_v2.am.json" et des fichiers de configurations "dataX.tar.gz", X partant de 0
