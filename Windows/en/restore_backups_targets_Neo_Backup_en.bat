...
REM Restore Neo-backup backups of packages specified in the file "packages_targets.txt" (and reinstall the package if not installed)
...
set "LIST_FILE=%CD%\packages_targets.txt"
...
if not exist "%LIST_FILE%" (
    echo "packages_targets.txt": file not found
    exit /b
)
